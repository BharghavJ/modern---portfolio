...
const projectsData = [
  {
    id: 1,
    name: "DC Motor Anomaly Detection",
    category: "ai",
    position: [2, 1, 0],
    color: "#00ffff",
    description: "Real-time anomaly detection using vibration and temperature signals for production equipment monitoring.",
    technologies: ["Python", "Time-Series", "Feature Engineering", "Condition Monitoring"],
    github: "#",
    demo: "#",
  ...
  {
    id: 2,
    name: "AI Fashion Image Generation",
    category: "ai",
    position: [-2, -1, 1],
    color: "#ff00ff",
    description: "Generated multilingual product imagery using Stable Diffusion XL and LoRA for retail-ready assets.",
    technologies: ["PyTorch", "Stable Diffusion", "LoRA", "CLIP"],
    github: "#",
    demo: "#",
    image: "/placeholder.svg?height=200&width=300",
  },
  {
    id: 3,
    name: "Propeller Blade Stress Analysis",
    category: "opensource",
    position: [0, 2, -2],
    color: "#ffff00",
    description: "Optimized marine propeller design in CATIA and analyzed structural performance with CFRP material selection.",
    technologies: ["CATIA V5", "Inventor", "CFRP", "Stress Analysis"],
    github: "#",
    demo: "#",
    image: "/placeholder.svg?height=200&width=300",
  },
  {
    ...
    position: [-1, 0, 2],
    color: "#00ff00",
    description: "Designed digital production workflows and data management strategies for Industry 4.0 manufacturing.",
    technologies: ["Power BI", "Excel", "PLM", "Data Analysis"],
    github: "#",
    demo: "#",
    image: "/placeholder.svg?height=200&width=300",
  },
