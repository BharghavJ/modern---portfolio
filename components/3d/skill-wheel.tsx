...
const skillsData = [
  {
    ...
    color: "#3776AB",
    position: [3, 0, 0],
    description: "Python for machine learning, production data analysis, and automation scripting.",
  },
  {
    name: "CATIA V5/V6",
    category: "CAD",
    ...
    color: "#FF8C00",
    position: [2.1, 2.1, 0],
    description: "Automotive BIW and exterior component design using CATIA for product development.",
  },
  {
    ...
    color: "#00B0F0",
    position: [0, 3, 0],
    description: "Developed anomaly detection and AI-driven workflows for industrial systems.",
  },
  {
    name: "DFMEA",
    category: "Quality",
    ...
    color: "#8A2BE2",
    position: [-2.1, 2.1, 0],
    description: "Failure mode and effects analysis for robust automotive design validation.",
  },
  {
    name: "Data Analysis",
    category: "Analytics",
    ...
    color: "#22C55E",
    position: [-3, 0, 0],
    description: "Manufacturing data analytics, Power BI reporting, and production insights.",
  },
  {
    name: "ENOVIA V6",
    category: "PLM",
    ...
    color: "#0EA5E9",
    position: [-2.1, -2.1, 0],
    description: "Product lifecycle management, BOM control, and release management workflows.",
  },
  {
    name: "Product Design",
    category: "Design",
    ...
    color: "#F59E0B",
    position: [0, -3, 0],
    description: "End-to-end automotive component design from concept through manufacturability.",
  },
  {
    name: "Industry 4.0",
    ...
    color: "#10B981",
    position: [2.1, -2.1, 0],
    description: "Digital production systems and cyber-physical production workflow expertise.",
  },
]
